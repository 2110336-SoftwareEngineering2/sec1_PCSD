      ...
      backgroundImage: `url(${background})`
       ...
       <div className="row">
        ...
        <div className="bottom">
            <div className="row">
              <Col xs="12">
                <h3 className="section-header">We’re the treat-your-dog-like-family dog people</h3>
              </Col>
            </div>
            <div className="row">
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Paper elevation={3} className="paper s">
            ...
            <Typography>Read verified reviews and pick the perfect caretaker</Typography>
          </Paper>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
        ...
        <TimelineContent>
          <Paper elevation={3} className="paper r">
            ...
            <Typography>Book and pay securely through the website or app</Typography>
          </Paper>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
