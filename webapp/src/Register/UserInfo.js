        ...
        return(
            <div className={this.state.classname}>
              <Register_header title={this.props.infotype}/>
                <NextButton func={this.changeClassName} type={this.props.infotype} updateFunc={this.props.updateFunc}/>
              {/*regis_header*/}
              {/*regis_info*/}
            </div>
        );
...
class NextButton extends React.Component {
    ...
    render() {
        return(
            <div>
                {!this.state.isNext ? <Register_info updateFunc={this.props.updateFunc}/> : <Info info={this.props.type}/>}
                {!this.state.isNext ? 
